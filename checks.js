...
assert.equal(addTime(10, 20, 0), '10:20', 'Правильно форматирует время');
assert.equal(addTime(1, 2, 0), '01:02', 'Правильно форматирует время');
assert.equal(addTime(12, 30, 2), '12:32', 'При добавлении 2 мин. к 12:30 получится 12:32');
